...
GUID = 'a3cfadaa-fee0-485d-a268-12fa175c9c51'
...
PrivateData = @{
    ...
    PSData = @{
        ...
        ProjectUri = 'https://github.com/hudsonm62/PS-Kari'

        # A URL to an icon representing this module.
        # IconUri = ''

        # ReleaseNotes of this module
        ReleaseNotes = 'https://github.com/hudsonm62/PS-Kari/blob/master/CHANGELOG.md'
